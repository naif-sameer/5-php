...
<body class="dark:bg-gray-800">
  <section class="mt-16 max-w-4xl p-6 mx-auto bg-white dark:bg-gray-700 rounded-md shadow-md ">
    <h2 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Login</h2>
    ...
    <form class="mt-4" action="" method="POST">
      ...
      if (isset($_POST['email'])) {
        $error_message = $user->login($_POST['email'], $_POST['password']);
      ...
      <div class="flex justify-end mt-6">
        <button type="submit" class="px-6 w-full py-2 leading-5 text-gray-900 transition-colors duration-200 transform bg-gray-200 rounded-md hover:bg-gray-400 focus:outline-none focus:bg-gray-400">Login</button>
      </div>
    </form>
  </section>
